  ...
  return (
      <PageCard>
            ...
            <Card bordered={false}>
              <Spin spinning={detailLoading === true}>
                <Descriptions title="组织信息">
                  <DescriptionItem span={3} label="组织名称">{record.orgName}</DescriptionItem>
                  <DescriptionItem span={3} label="组织类型">{getValueByKey(TYPE,['value','label'],record.orgType)}</DescriptionItem>
                  <DescriptionItem span={3} label="组织编码">{record.orgCode}</DescriptionItem>
                  <DescriptionItem span={3} label="组织简介">{record.orgDesc}</DescriptionItem>
                </Descriptions>
              </Spin>
            </Card>
          </Col>
        ...
        <CommonModalForm
          ...
          formItems={formItems}
          formData={formData}
          handleCallback={() => { handleSearch(); onSelect([record.sid])}}
