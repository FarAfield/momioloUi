          ...
          <Row gutter={24}>
            <Col span={14}>
              <Form
                ...
                onFinish={onFinish}
              >
                <FormItem name={'userName'} label={'昵称'} rules={[{ message: "最大字符长度8", max:8}]}>
                  <Input placeholder={'请输入昵称'} allowClear />
                </FormItem>
                <FormItem name={'userMobile'} label={'手机号'} rules={[{ message: "请输入合法的手机号", pattern: /^1\d{10}$/}]}>
                ...
                <FormItem name={'userMail'} label={'邮箱'} rules={[{ message: "请输入合法的邮箱", pattern: /^([a-zA-Z0-9_-])+@([a-zA-Z0-9_-])+(.[a-zA-Z0-9_-])+/}]}>
                  <Input placeholder={'请输入邮箱'} allowClear />
                </FormItem>
                <FormItem name={'userLocation'} label={'地址'} rules={[{ message: "最大字符长度50", max:50 }]}>
                  <Input placeholder={'请输入地址'} allowClear />
                </FormItem>
                <FormItem name={'userAvatar'} label={'头像链接'} rules={[{ message: "最大字符长度1000", max:1000 }]}>
