        ...
        case 'input': {
          ...
          return (
              <FormItem key={key} name={key} label={title} rules={rules}>
                <Input placeholder={placeholder} allowClear maxLength={maxLength} disabled={disabled} {...rest}/>
              </FormItem>
          )
        }
        case 'textArea': {
          ...
          return (
              <FormItem key={key} name={key} label={title} rules={rules}>
                <TextArea placeholder={placeholder} maxLength={maxLength} rows={rows} disabled={disabled} {...rest}/>
              </FormItem>
          )
        }
        case 'select': {
